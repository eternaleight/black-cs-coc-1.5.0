...
<div id="go-to-top" class="go-to-top">
  <?php if ( get_go_to_top_button_image_url() ): //カスタマイザーでトップへ戻る画像が指定されている時 ?>
    <a class="go-to-top-button go-to-top-common go-to-top-hide go-to-top-button-image"<?php echo $on; ?>><img src="<?php echo get_go_to_top_button_image_url(); ?>" alt="<?php _e( 'トップへ戻る', "aaaaaaaaaaaaaaaaaaaaaaaaaa" ) ?>"></a>
  <?php else: ?>
